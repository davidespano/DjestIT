            ...
            <div id="up-bar">
                <div class="btn-toolbar left-bar" role="navigation" id="cmd-bar">
                    <div class="btn-group">
                        ...
                        <ul id="gesture-menu" class="dropdown-menu" role="menu">
                            <li><a id="btn-swipe-right" href="#">Arc 1 counter clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 2 counter clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 3 counter clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 4 counter clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 1 clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 2 clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 3 clock-wise</a></li>
                            <li><a id="btn-swipe-right" href="#">Arc 4 clock-wise</a></li>
                        </ul>
                    </div>
                    <div class="btn-group">
                ...
                <div id="test-bar" class="center-bar">
                    <div class="alert alert-success  test-msg" role="alert">
                        ...
                        <span>
                            <h3>1 - Arco 1 senso antioriario: dimostrazione</h3>
                            <p>
                        ...
                        <span>
                            <h3>2 - Arco 2 senso antioriario</h3>
                            <p>
                                Guarda attentantamente la traiettoria del gesto.
                                Premi "Continua" per eseguirlo o "Ripeti" per 
                                rivedere la traiettoria.
                        ...
                        <span>
                            <h3>3 - Arco 3 senso antioriario</h3>
                            <p>
                                Guarda attentantamente la traiettoria del gesto.
                                Premi "Continua" per eseguirlo o "Ripeti" per 
                                rivedere la traiettoria.
                        ...
                        <span>
                            <h3>4 - Arco 4 senso antioriario</h3>
                            <p>
                                Guarda attentantamente la traiettoria del gesto.
                                Premi "Continua" per eseguirlo o "Ripeti" per 
                                rivedere la traiettoria.
